...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li><strong>.glb Files</strong>: 3D models for house design visualizations.</li>
        ...
        <p>3. Explore AI-generated house design recommendations displayed in 3D using .glb files.</p>
...
├── assets/                 # .glb files and other static assets
